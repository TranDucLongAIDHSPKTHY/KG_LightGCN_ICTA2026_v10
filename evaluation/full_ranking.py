"""evaluation/full_ranking.py — v10. Full-item ranking evaluation."""
...
def full_ranking_eval(
    ...
    """Full-item ranking — protocol chính của v10 (eval_protocol: full)."""
